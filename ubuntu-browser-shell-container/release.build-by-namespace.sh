...
nsc build --push --platform=linux/arm64,linux/amd64 --tag ghcr.io/${GITHUB_USER}/containers/ubuntu-shell-container:noble-$UNIXTIME \
                                                    --tag ghcr.io/${GITHUB_USER}/containers/ubuntu-shell-container:noble-latest -f Dockerfile.noble .

nsc build --push --platform=linux/arm64,linux/amd64 --tag ghcr.io/${GITHUB_USER}/containers/ubuntu-shell-container:jammy-$UNIXTIME \
